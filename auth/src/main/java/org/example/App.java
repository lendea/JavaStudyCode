...
//            byte[] keyBytes = Base64.getDecoder().decode(privateKey.getBytes());
    ...
    public static void main(String[] args) {
        ...
        Jws<Claims> claimsJws = Jwts.parser().setSigningKey(key2).build().parseClaimsJws(jws2);

//        Jws<Claims> claimsJws = Jwts.parser().setSigningKey(key).build().parseClaimsJws(jws2);
